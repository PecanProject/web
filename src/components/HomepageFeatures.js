		...
		<div style={{ padding: "4rem 0" }}>
			...
			<div className={styles.foot}>
				...
				<div className={styles.imageContainer}>
					<img
						src="https://res.cloudinary.com/dhwbs4kk2/image/upload/v1679548055/Pecan/nsf_qw8bgf.png"
						className={styles.image}
					/>
					<img
						src="https://res.cloudinary.com/dhwbs4kk2/image/upload/v1679548054/Pecan/nasa-logo_ydmuym.png"
						className={styles.image}
					/>
					<img
						src="https://res.cloudinary.com/dhwbs4kk2/image/upload/v1679548054/Pecan/dep-energysvg_pwuk6w.png"
						className={styles.image}
					/>
